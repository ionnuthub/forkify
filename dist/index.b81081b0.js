...
B=function(e){if(Y(e))throw J("Can't call method on "+e);return e},q=function(e){return H(B(e))};var K={},Q={},V={},X={},Z={},ee="object"==typeof document&&document.all,et=(Z={all:ee,IS_HTMLDDA:void 0===ee&&void 0!==ee}).all;// `IsCallable` abstract operation
...
ew=function(e,t){var r,n;if("string"===t&&X(r=e.toString)&&!V(n=F(r,e))||X(r=e.valueOf)&&!V(n=F(r,e))||"string"!==t&&X(r=e.toString)&&!V(n=F(r,e)))return n;throw ek("Can't convert object to primitive value")};var eE={},eS={};eS=!1;var eO={},e$={},ej=Object.defineProperty;e$=function(e,t){try{ej(O,e,{value:t,configurable:!0,writable:!0})}catch(r){O[e]=t}return t};var eL="__core-js_shared__";eO=O[eL]||e$(eL,{}),(eE=function(e,t){return eO[e]||(eO[e]=void 0!==t?t:{})})("versions",[]).push({version:"3.32.2",mode:eS?"pure":"global",copyright:"\xa9 2014-2023 Denis Pushkarev (zloirock.ru)",license:"https://github.com/zloirock/core-js/blob/v3.32.2/LICENSE",source:"https://github.com/zloirock/core-js"});var eF={},eM={},ex=Object;// `ToObject` abstract operation
...
Q=function(e,t){if(!V(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!V(r)||en(r))return r;throw eD("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
K=function(e){var t=Q(e,"string");return en(t)?t:t+""};var eW={},ez={},eU=O.document,eG=V(eU)&&V(eU.createElement);ez=function(e){return eG?eU.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
tS=ei("Reflect","ownKeys")||function(e){var t=p(eK(e));return f?tD(t,f(e)):t},tE=function(e,t,r){for(var n=tS(t),o=0;o<n.length;o++){var a=n[o];eF(e,a)||r&&eF(r,a)||c(e,a,i(t,a))}};var tR={},tW=/#|\.prototype\./,tz=function(e,t){var r=tG[tU(e)];return r===tY||r!==tB&&(X(t)?L(t):!!t)},tU=tz.normalize=function(e){return String(e).replace(tW,".").toLowerCase()},tG=tz.data={},tB=tz.NATIVE="N",tY=tz.POLYFILL="P";tR=tz,/*
...
if(a=t[n],o=e.dontCallGetSet?(s=i(r,n))&&s.value:r[n],!tR(u?n:c+(l?".":"#")+n,e.forced)&&void 0!==o){if(typeof a==typeof o)continue;tE(a,o)}(e.sham||o&&o.sham)&&eY(a,"sham",!0),e4(r,n,a,e)}};var tJ={},tK={},tQ=Function.prototype,tV=tQ.apply,tX=tQ.call;// eslint-disable-next-line es/no-reflect -- safe
tK="object"==typeof Reflect&&Reflect.apply||(M?tX.bind(tV):function(){return tX.apply(tV,arguments)});var tZ={},t0={},t1=(t0=function(e){// Nashorn bug:
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t5&&t6||(t5=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tK(t,void 0,r)},v(ro),ro},t6=function(e){delete ra[e]},t8?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t9?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rp=(tJ={set:t5,clear:t6}).clear;// `clearImmediate` method
// http://w3c.github.io/setImmediate/#si-clearImmediate
S({global:!0,bind:!0,enumerable:!0,forced:O.clearImmediate!==rp},{clearImmediate:rp});var rf=tJ.set,rh={},rv={};/* global Bun -- Deno case */rv="function"==typeof Bun&&Bun&&"string"==typeof Bun.version;var rg=O.Function,rm=/MSIE .\./.test(eu)||rv&&((t=O.Bun.version.split(".")).length<3||"0"===t[0]&&(t[1]<3||"3"===t[1]&&"0"===t[2]));// IE9- / Bun 0.3.0- setTimeout / setInterval / setImmediate additional parameters fix
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#timers
// https://github.com/oven-sh/bun/issues/1633
rh=function(e,t){var r=t?2:1;return rm?function(n,i/* , ...arguments */){var o=t4(arguments.length,1)>r,a=X(n)?n:rg(n),s=o?t3(arguments,r):[],c=o?function(){tK(a,this,s)}:a;return t?e(c,i):e(c)}:e};// https://github.com/oven-sh/bun/issues/1633
...
1===e&&t>1?`
      ...
      `:"")}}var rz=new rW;class rU extends rI{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return this._data.map(e=>rC.render(e,!1)).join("")}}var rG=new rU;class rB extends rI{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rY=new rB;const rJ=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rH.renderSpinner(),rR.update(rj()),rG.update(rE.bookmarks),// 2) Loading recipe
await rO(e),rH.render(rE.recipe)}catch(e){rH.renderError(),console.error(e)}},rK=async function(){try{rR.renderSpinner();// 1) Get search query
let e=rA.getQuery();if(!e)return;// 2) Load search results
await r$(e),rR.render(rj()),rz.render(rE.search)}catch(e){console.log(e)}},rQ=async function(e){try{rY.renderSpinner(),// Upload the new recipe data
await rP(e),console.log(rE.recipe),rH.render(rE.recipe),rY.renderMessage(),rG.render(rE.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),// Close form window
setTimeout(function(){rY.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),rY.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rH.addHandlerRender(rJ),rH.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
rL(e),rH.update(rE.recipe)}),rH.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rx(rE.recipe.id):rM(rE.recipe),rH.update(rE.recipe),rG.render(rE.bookmarks)}),rA.addHandlerSearch(rK),rz.addHandlerClick(function(e){rR.render(rj(e)),rz.render(rE.search)}),rY.addHandlerUpload(rQ);//# sourceMappingURL=index.b81081b0.js.map

//# sourceMappingURL=index.b81081b0.js.map
